    ...
    def check_exist_reservation(self):
        ...
        for object in objects:
            if object.id == self.id:
                continue
            if ((object.time_start <= self.time_start <= object.time_end) or (object.time_start <= self.time_end <= object.time_end)) and object.time_start.date() == self.time_start.date() :
